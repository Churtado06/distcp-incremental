...
def trigger_dag(data, context=None):
    ...
    client_id = '753033777830-5d745vfbu33iu4adgbs06ibp8jbo6kj6.apps.googleusercontent.com'
    # This should be part of your webserver's URL:
    # {tenant-project-id}.appspot.com
    webserver_id = 'm251339a5c936f955p-tp'
    #webserver_id = 'race59fa8e2d17be1p-tp'
    # The name of the DAG you wish to trigger
    dag_name = 'distcp_incremental_data_load_dag'
